    ...
    <div class="row align-items-center">
      <div class="col-lg-4">
        <div class="about-images">
         <figure class="image-anime">
          ...
          <img src="{{ asset('frontend/assets/img/elements/star1.png')}}" alt="" class="star1 keyframe5">
        </div>
      </div>
      <div class="col-lg-5">
        <div class="about-content-area heading2">
          ...
          <a href="about.html">
            <img src="{{ asset('frontend/assets/img/elements/elements4.png')}}" alt="" class="elements4 keyframe5">
      ...
      <div class="col-lg-3">
        <div class="about-auhtor-images">
          <img src="{{ asset('frontend/assets/img/elements/elements5.png')}}" alt="" class="elements5 keyframe5">
          <figure class="image-anime">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="about-all-images-area">
                    <img src="{{ asset('frontend/assets/img/elements/elements14.png')}}" alt="" class="elements12 keyframe5">
                    <img src="{{ asset('frontend/assets/img/elements/elements15.png')}}" alt="" class="elements13 keyframe5">
                    <div class="row">
                      <div class="col-lg-6 col-md-6">
                        <div class="img1 image-anime">
                            <div class="space100"></div>
                          <img src="{{ asset('frontend/assets/img/all-images/about-img6.png')}}" alt="">
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6">
                        <div class="img2 image-anime">
                          <img src="{{ asset('frontend/assets/img/all-images/about-img5.png')}}" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="service2-header heading2 text-center">
          <img src="{{ asset('frontend/assets/img/elements/star7.png')}}" alt="" class="star2 keyframe5">
          <img src="{{ asset('frontend/assets/img/elements/star7.png')}}" alt="" class="star3 keyframe5">
          <h5>Our Value</h5>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="team-boxarea">
            ...
            <ul>
              <li><a href="#"><img src="{{ asset('frontend/assets/img/icons/facebook.svg')}}" alt=""></a></li>
              <li><a href="#"><img src="{{ asset('frontend/assets/img/icons/instagram.svg')}}" alt=""></a></li>
              <li><a href="#"><img src="{{ asset('frontend/assets/img/icons/linkedin.svg')}}" alt=""></a></li>
              <li><a href="#" class="m-0"><img src="{{ asset('frontend/assets/img/icons/youtube.svg')}}" alt=""></a></li>
            </ul>
            <div class="content">
        ...
        <div class="testimonials-slider-area owl-carousel">
              ...
              <div class="col-lg-5">
                <div class="pera">
                  ...
                  <div class="list-area">
                    ...
                    <img src="{{ asset('frontend/assets/img/icons/google.svg')}}" alt="">
                  </div>
                </div>
              </div>
              <div class="col-lg-7">
                <div class="images">
                  <img src="{{ asset('frontend/assets/img/all-images/testimonial-img1.png')}}" alt="">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="testimonial-boxarea">
            <div class="row">
              ...
              <div class="col-lg-7">
                <div class="images">
                  <img src="{{ asset('frontend/assets/img/all-images/testimonial-img2.png')}}" alt="">
                </div>
              </div>
            </div>
          </div>
